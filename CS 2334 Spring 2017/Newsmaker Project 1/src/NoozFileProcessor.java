...
public class NoozFileProcessor {
	...
	private static void processLine(String line) {
		...
		String newsPaper = decodeNewspaper(lineList[1]);
		...
		if (newsMakerName1.equals("None") && newsMakerName2.equals("None")) {
			if (!newsMakers.contains(newsMaker1)) {
				newsMaker1.addNewspaperStory(
						new NewspaperStory(date, newsPaper, wordCount, topic, newsMaker1, newsMaker1));
			...
			if (!newsMakers.contains(newsMaker2)) {
				newsMaker2.addNewspaperStory(
						new NewspaperStory(date, newsPaper, wordCount, topic, newsMaker1, newsMaker2));
			...
			newsMaker1 = newsMakers.get(newsMaker1);
			newsMaker2 = newsMakers.get(newsMaker2);
			NewspaperStory story = new NewspaperStory(date, newsPaper, wordCount, topic, newsMaker1, newsMaker2);
